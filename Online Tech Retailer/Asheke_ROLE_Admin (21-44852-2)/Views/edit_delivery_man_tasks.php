...
if(isset($_GET['edit_delivery_man_task_id'])){
$edit_delivery_man_task_id=$_GET['edit_delivery_man_task_id'];
$_SESSION['edit_delivery_man_task_id']=$edit_delivery_man_task_id;
...
<html>
<head>
  <title>Edit Delivery Man Task</title> 
  <link rel="stylesheet" href="../CSS/edit_task.css">
  <script type="text/javascript" src="js/edit_delivery_man_tasks.js"></script>
</head>
<body>
  
  <h4>Edit Task</h4>
  <form action="../Controllers/edit_delivery_man_tasks_action.php" method="POST" onsubmit="return validate();" novalidate>
    <table>
    <tr>
