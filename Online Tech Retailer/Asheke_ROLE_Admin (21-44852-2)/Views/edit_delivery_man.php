...
$name=$row['Name'];                                                                                                                                                                                                                                                
$delivery_man_id=$row['Delivery Man PIN'];                                                                                                                                                                                                                                                
$email=$row['Email'];                                                                                                                                                                                                                                                
$salary=$row['Salary'];                                                                                                                                                                                                                                                
$bonus=$row['Bonus'];   
...
<html>
    ...
    <script type="text/javascript" src="js/edit_delivery_man.js"></script>
    </head>
    <body>
    <form  action="../Controllers/edit_delivery_man_action.php" method="post" onsubmit="return validate();"  novalidate; >
                
                <fieldset>
                <table>
                    <legend>Edit Delivery Man</legend>
                    ...
                    <tr>
                        <th><label for="delivery_man_id">Delivery Man PIN</label></th>
                        <td>:</td>
                        <td><input type="number" id="delivery_man_id" name="delivery_man_id" placeholder="Delivery Man ID" value="<?php echo $delivery_man_id ;?>">
