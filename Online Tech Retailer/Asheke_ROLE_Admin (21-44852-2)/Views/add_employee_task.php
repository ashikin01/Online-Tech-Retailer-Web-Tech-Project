...
if(isset($_GET['add_employee_task_user_id'])){
$add_employee_task_user_id=$_GET['add_employee_task_user_id'];
$_SESSION['add_employee_task_user_id']=$add_employee_task_user_id;
...
<head>
  ...
  <script type="text/javascript" src="js/add_employee_task.js"></script>
</head>
<body>
  
  <h4>Add a New Task</h4>
  <form action="../Controllers/add_employee_task_action.php" method="POST" onsubmit="return validate();" novalidate>
    <table>
    <tr>
